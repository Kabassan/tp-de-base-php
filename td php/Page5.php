...
$result=is__not_number($matricule);
$result=is__not_number($matricule);
$result=is__not_number($matricule);
$result=is__not_number($matricule);
$result=is__not_number($matricule);
...
?>
    ...
    <form action=" " method="post">
        ...
        Service <select name="service" class="service" required>
            ...
            <option value="choix1">progammation</option>
            <option value="choix2">design</option>
        </select>
        <?php if(isset($errors['matricule'])){ ?>
        <div class="alert alert-danger">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        ...
        Fonction <select name="fonction" required>
            <option value="choix">Choisir</option>
            <option value="choix1">developper</option>
            <option value="choix2">web-designer</option>
        </select>
        <?php if(isset($errors['matricule'])){ ?>
        <div class="alert alert-danger">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
